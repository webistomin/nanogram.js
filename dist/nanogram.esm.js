...
function () {
  ...
  Nanogram.prototype.getCitiesByCountryId = function (countryId) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      var result, url, response, _b, city_list, country_info;
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            response = _c.sent();
            _b = __assign({}, (_a = response === null || response === void 0 ? void 0 : response.entry_data) === null || _a === void 0 ? void 0 : _a.LocationsDirectoryPage[0]), city_list = _b.city_list, country_info = _b.country_info;
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            response = _c.sent();
            _b = __assign({}, (_a = response === null || response === void 0 ? void 0 : response.entry_data) === null || _a === void 0 ? void 0 : _a.LocationsDirectoryPage[0]), city_info = _b.city_info, country_info = _b.country_info, location_list = _b.location_list;
